...
export const users = sqliteTable("users", {
  ...
  // Travel Mode Sync — device-reported IANA timezone string (e.g. "America/New_York").
  // Updated on every app open via PATCH /api/user/timezone so push notifications
  // fire at the correct physical local time after the user travels.
